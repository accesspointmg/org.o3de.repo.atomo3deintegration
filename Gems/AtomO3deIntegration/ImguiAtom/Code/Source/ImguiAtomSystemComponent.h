...
namespace AZ
{
    namespace O3DEIntegration
    {
        class ImGuiFeatureProcessor;

        //! When Atom is enabled, ImGuiManager from O3DE's ImGui gem will hand over drawing of ImGui via @OtherActiveImGuiRequestBus to this system component.
        //! Note: The O3DE ImGui gem only supports a single ImGui context, so Atom must have a single ImGui pass marked as the default.
