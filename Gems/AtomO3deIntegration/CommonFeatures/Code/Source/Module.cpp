...
#ifdef atomo3deINTEGRATION_FEATURE_COMMON_EDITOR
...
namespace AZ
{
    namespace Render
    {
        class AtomO3deIntegrationCommonFeaturesModule
            : public AZ::Module
        {
        public:
            AZ_RTTI(AtomO3deIntegrationCommonFeaturesModule, "{E6FF4862-9355-4B23-AE00-B936F0C6E6C9}", AZ::Module);
            AZ_CLASS_ALLOCATOR(AtomO3deIntegrationCommonFeaturesModule, AZ::SystemAllocator);

            AtomO3deIntegrationCommonFeaturesModule()
                : AZ::Module()
            {
                m_descriptors.insert(m_descriptors.end(), {
                        AtomO3deIntegrationCommonFeaturesSystemComponent::CreateDescriptor(),
            ...
            AZ::ComponentTypeList GetRequiredSystemComponents() const override
            {
                return AZ::ComponentTypeList{
                    azrtti_typeid<AtomO3deIntegrationCommonFeaturesSystemComponent>(),
#ifdef atomo3deINTEGRATION_FEATURE_COMMON_EDITOR
...
AZ_DECLARE_MODULE_CLASS(AZ_JOIN(Gem_, O3DE_GEM_NAME), AZ::Render::AtomO3deIntegrationCommonFeaturesModule)
#else
AZ_DECLARE_MODULE_CLASS(Gem_CommonFeaturesAtom, AZ::Render::AtomO3deIntegrationCommonFeaturesModule)
#endif
