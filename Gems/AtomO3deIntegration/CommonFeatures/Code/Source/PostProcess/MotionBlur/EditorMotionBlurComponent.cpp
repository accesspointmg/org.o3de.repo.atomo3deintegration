    ...
    namespace Render
    {
        void EditorMotionBlurComponent::Reflect(AZ::ReflectContext* context)
        {
            ...
            if (AZ::SerializeContext* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
            {
                ...
                {
                    editContext->Class<EditorMotionBlurComponent>(QT_TRANSLATE_NOOP("AtomO3deIntegration", "Motion Blur"), QT_TRANSLATE_NOOP("AtomO3deIntegration", "Controls the Motion Blur"))
                    ...
                    editContext->Class<MotionBlurComponentConfig>("MotionBlurComponentConfig", "")
                        ->DataElement(
                            Edit::UIHandlers::CheckBox, &MotionBlurComponentConfig::m_enabled, QT_TRANSLATE_NOOP("AtomO3deIntegration", "Enable Motion Blur"), QT_TRANSLATE_NOOP("AtomO3deIntegration", "Enable Motion Blur."))
                        ->Attribute(Edit::Attributes::ChangeNotify, Edit::PropertyRefreshLevels::ValuesOnly)

                        ->DataElement(AZ::Edit::UIHandlers::Slider, &MotionBlurComponentConfig::m_strength, QT_TRANSLATE_NOOP("AtomO3deIntegration", "Strength"), QT_TRANSLATE_NOOP("AtomO3deIntegration", "Strength of the Effect"))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Slider, &MotionBlurComponentConfig::m_sampleNumber, QT_TRANSLATE_NOOP("AtomO3deIntegration", "Sample Number"), QT_TRANSLATE_NOOP("AtomO3deIntegration", "Number of Sample Points Per Pixel"))
                        ...
                        // Overrides
                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("AtomO3deIntegration", "Overrides"))
