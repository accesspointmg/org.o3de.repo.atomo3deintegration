...
DCCSI_APP_HELP_URL = "https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Maya/readme.md"

# default generic help url (should be replaced per-tool)
HELP_URL = 'https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/readme.md'
# -------------------------------------------------------------------------
