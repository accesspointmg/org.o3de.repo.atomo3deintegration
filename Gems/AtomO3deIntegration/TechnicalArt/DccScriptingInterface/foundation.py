...
It installs based on the python version into a location (such as):
    '<o3de>/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/3rdParty/Python/Lib/3.x'
...
from: '<o3de>/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/3rdParty/Python/Lib/3.x'
to (windows): '/Users/<Username>/AppData/Local/Programs/'

Open an admin elevated cmd prompt here:
    '<o3de>/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface'
