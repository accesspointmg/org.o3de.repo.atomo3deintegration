...
class DccsiAbout(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        dccsi_readme_url = 'https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/readme.md'

        dccsi_maya_readme_url = 'https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Maya/readme.md'

        dccsi_maya_scene_exporter_url = 'https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Maya/Scripts/Python/scene_exporter/readme.md'

        dccsi_blender_readme_url = 'https://github.com/o3de/o3de/blob/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Blender/readme.md'

        dccsi_blender_scene_exporter_url = 'https://github.com/o3de/o3de/blob/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Blender/Scripts/addons/SceneExporter/README.md'

        dccsi_wing_readme_url = 'https://github.com/o3de/o3de/blob/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/IDE/Wing/readme.md'
