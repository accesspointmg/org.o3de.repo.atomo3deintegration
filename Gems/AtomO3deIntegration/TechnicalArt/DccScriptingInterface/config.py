...
Example, create such as file:
    "< o3de >/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/.env"
...
"C:/Depot/o3de-dev/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/Dev/Windows/Env_Dev.bat"
