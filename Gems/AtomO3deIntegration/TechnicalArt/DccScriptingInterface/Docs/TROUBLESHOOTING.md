...
`C:\depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface`
...
`target_loc = C:/path/to/o3de/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/3rdParty/Python/Lib/3.x/3.10.x/site-packages`
