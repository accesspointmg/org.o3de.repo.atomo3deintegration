...
`C:/path/to/o3de/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface`
...
    `C:\path\to\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface`
...
From .bat file, double-click the following file type to start Maya:`C:\path\to\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\IDE\Wing\win_launch_wingide.bat`
