...
set "PATH_O3DE_TECHART_GEMS=%O3DE_DEV%\Gems\AtomO3deIntegration\TechnicalArt"
...
set "PATH_DCCSIG=%O3DE_DEV%\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface"
