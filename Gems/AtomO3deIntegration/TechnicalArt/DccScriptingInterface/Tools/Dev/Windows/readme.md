...
1. Option 1) Run the DCCsi cmd: < O3DE >/DccScriptingInterface/Tools/Dev/Windows/__Launch_O3DE_PY_Cmd__.bat
    ...
    - CWD: C:\< O3DE >\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface>
...
2. Option 2) Opn a command prompt from this location: "C:\< O3DE >\python\"
    ...
    - CWD: C:\< O3DE >\python>
    - Run command (prompt):>python "C:\Depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\config.py" -dm=True -py=True -qt=True -tp=True
