...
:: Version: 0.0.1
:: Support: Blender 3
:: Readme.md:  https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Blender
:: Notes:
...
:: <O3DE>\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\3rdParty\Python\Lib
