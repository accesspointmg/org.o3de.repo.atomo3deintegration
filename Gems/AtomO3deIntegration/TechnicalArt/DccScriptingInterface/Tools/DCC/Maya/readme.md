...
```batch
cd C:\path\to\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface
```
...
https://github.com/o3de/o3de/tree/development/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface
...
From .bat file, double-click the following file type to start Maya: `C:\path\to\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\DCC\Maya\win_launch_mayapy_2023.bat`
...
The Maya env can be modified by adding this file:`C:\path\tp\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\DCC\Maya\Env_Dev.bat`
...
So as to not directly modify Maya, we bootstrap additional access to site-packages in our `userSetup.py`:
    ...
    C:/Depot/o3de/Gems/AtomO3deIntegration/TechnicalArt/DccScriptingInterface/Tools/DCC/Maya/Scripts/userSetup.py
...
This is where the legacy py2.7 version of requirements is stored:                           
    ...
    C:\path\to\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\Resources\py27\requirements.txt
...
```batch
mayapy -m pip install -r C:\Depot\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\DCC\Maya\requirements.txt -t C:\Depot\o3de\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\3rdParty\Python\Lib\2.x\2.7.x\site-packages
```
...
```batch
mayapy2 -m pip install -r C:\Depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\Tools\DCC\Maya\requirements.txt -t C:\Depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\3rdParty\Python\Lib\2.x\2.7.x\site-packages
```
...
```batch
mayapy -m pip install -r C:\Depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\requirements.txt -t C:\Depot\o3de-dev\Gems\AtomO3deIntegration\TechnicalArt\DccScriptingInterface\3rdParty\Python\Lib\3.x\3.10.x\site-packages
```
